 ...
 *     screenshow_endpoint?: scalar|null|Param, // Default: "%env(default::SCREENSHOW_ENDPOINT)%"
 ...
 *         theme?: scalar|null|Param, // Default: "_none_"
 *         connection?: scalar|null|Param, // Default: null
 *         exclude?: list<scalar|null|Param>,
 *     },
 *     class?: array{
 *         filename?: scalar|null|Param, // Default: "%kernel.project_dir%/class"
 *         size?: "mini"|"midi"|"maxi"|Param, // Default: "midi"
 *         theme?: scalar|null|Param, // Default: "_none_"
 *         em?: scalar|null|Param, // Default: null
 *         exclude?: list<scalar|null|Param>,
 *     },
 *     convert?: array{
 *         format?: "puml"|"png"|"svg"|Param, // Default: "svg"
 *         converter?: "auto"|"jar"|"server"|Param, // Default: "auto"
 *         jar?: scalar|null|Param, // Default: null
 ...
 *     filename?: scalar|null|Param, // The name of the file containing the version information. // Default: "version"
 *     filepath?: scalar|null|Param, // The path to the file containing the version information. // Default: "%kernel.project_dir%/config"
 ...
 *         handler?: scalar|null|Param, // The handler used for the VCS integration, set to null to disable the integration. // Default: "git"
 *         commit_message?: scalar|null|Param, // The message to use for the VCS commit. // Default: "Update application version to %s"
 ...
 *         tag_message?: scalar|null|Param, // The message to use for the VCS tag. // Default: "Update application version to %s"
 *         name?: scalar|null|Param, // The name used for the VCS commit information, set to null to use the default VCS configuration. // Default: null
 *         email?: scalar|null|Param, // The email used for the VCS commit information, set to null to use the default VCS configuration. // Default: null
 *         path_to_executable?: scalar|null|Param, // The path to the VCS executable, set to null for autodiscovery. // Default: null
 *     },
 * }
 ...
 *     base_layout?: scalar|null|Param, // Default: null
 *     subdomain_variable?: scalar|null|Param, // Default: "subdomain"
