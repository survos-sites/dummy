 ...
 *     root?: scalar|null, // If not set, must be passed to each call // Default: null
 *     api_endpoint?: scalar|null, // Default: "https://sais.survos.com"
 ...
 *     screenshow_endpoint?: scalar|null, // Default: "%env(default::SCREENSHOW_ENDPOINT)%"
 *     user_provider?: scalar|null, // Default: null
 *     user_class?: scalar|null, // Default: "App\\Entity\\User"
 * }
 ...
 *     format?: "yaml", // The format used for the version file. // Default: "yaml"
 ...
 *         tagging_mode?: \Bizkit\VersioningBundle\VCS\TaggingMode::Always|\Bizkit\VersioningBundle\VCS\TaggingMode::Ask|\Bizkit\VersioningBundle\VCS\TaggingMode::Never, // The mode for applying tags to version commits: - 'always': automatically add a tag without prompting - 'never': do not add a tag - 'ask': prompt before tagging when incrementing versions // Default: "ask"
 ...
 *         exclude?: list<scalar|null>,
 *         orm?: array{
 *             entity_class?: scalar|null, // Your Doctrine entity class that extends "Zenstruck\Messenger\Monitor\History\Model\ProcessedMessage"
 *         },
 *     },
 *     cache?: array{
 *         pool?: scalar|null, // Cache pool to use for worker cache. // Default: "cache.app"
 ...
 *     max_per_route?: scalar|null, // Default: 3
 *     base_url?: scalar|null, // Default: "https://127.0.0.1:8000"
 *     initial_path?: scalar|null, // Default: "/"
 *     user?: scalar|null, // Default: "juan@tt.com"
 *     login_path?: scalar|null, // Default: "/login"
 *     username_form_variable?: scalar|null, // Default: "_username"
 *     password_form_variable?: scalar|null, // Default: "_password"
 *     plaintext_password?: scalar|null, // Default: "password"
 *     submit_button?: scalar|null, // Default: ".btn"
 *     user_class?: scalar|null, // Default: "App\\Entity\\User"
 *     max_depth?: scalar|null, // Default: 1
 * }
 ...
 *                     gravity?: array{
 *                         type?: "no"|"so"|"ea"|"we"|"noea"|"nowe"|"soea"|"sowe"|"ce", // Default: "ce"
 ...
 *     pagination?: array{
 *         per_page?: int, // Number of media items to display per page. // Default: 20
 *     },
 *     upload?: array{
